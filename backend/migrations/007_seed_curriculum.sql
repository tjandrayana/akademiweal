...
UPDATE lessons SET
  ...
  explanation = 'Alat tukar mempermudah pertukaran barang dan jasa tanpa barter langsung.'
...
SELECT 3,
  ...
  'Volatilitas berarti harga bisa naik atau turun dalam periode singkat akibat perubahan sentimen dan informasi.'
